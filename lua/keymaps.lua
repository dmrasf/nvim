...
vim.keymap.set('n', 'sd', ':set splitright<cr>:vsplit<cr>', { noremap = true })
vim.keymap.set('n', 'sa', ':set nosplitright<cr>:vsplit<cr>', { noremap = true })
vim.keymap.set('n', 'sw', ':set nosplitbelow<cr>:split<cr>', { noremap = true })
vim.keymap.set('n', 'ss', ':set splitbelow<cr>:split<cr>', { noremap = true })
